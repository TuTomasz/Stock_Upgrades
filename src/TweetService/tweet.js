...
puppeteer.launch({ headless: false }).then(async (browser) => {
    ...
    // const elements = await page.$x('//*[@id="mainNavigation"]/div[3]/div/div/div[1]/button')
    ...
    // //input username
    // const username = await page.$x('//*[@id="app"]/div/div/div[4]/div[2]/div/form/div[1]/div[1]/label/input')
    ...
    // //input password
    // const password = await page.$x('//*[@id="app"]/div/div/div[4]/div[2]/div/form/div[1]/div[2]/label/input')
    ...
    const queue = fs.readFileSync('../../data/Queue/Queue.json', 'utf8').split('\n');
